...
export default function CustomerDashboard({ user }) {
  ...
  // -------------------------------
  // 1. LOAD SERVICES (for checkboxes)
  // -------------------------------
  useEffect(() => {
  ...
  // -------------------------------
  // 2. LOAD USER REQUEST HISTORY + MESSAGES
  // -------------------------------
  ...
  return (
    <div style={{ width: "70%", margin: "auto", marginTop: "30px" }}>
      ...
      {/* BUTTON TO SHOW PREVIOUS REQUESTS + MESSAGES */}
      <button
      ...
      >
        View My Previous Requests & Messages
      </button>

      {/* ------------------------------------
          REQUEST HISTORY + MESSAGES PANEL
      ------------------------------------- */}
      {showRequests && (
        <div
          style={{
            ...
            >
              ...
              <div style={{ marginTop: "10px" }}>
                ...
                {(!r.messages || r.messages.length === 0) && (
                  <p style={{ marginTop: "4px" }}>No messages yet.</p>
                )}
