      ...
      <Route
        ...
        element={
          <>
            ...
            <section id="services" className="Servicesection">
              <div className="container text-center">
                ...
                <div className="row g-3">
                  {/* If DB is empty, you can still show nothing or a message;
                      for now we just map whatever is there. */}
            ...
            {/* PROJECTS SECTION (still static for now) */}
